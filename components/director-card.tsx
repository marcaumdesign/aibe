...
export default function DirectorCard({
  ...
  return (
    <div
      ...
      onClick={handleClick}
    >
      <div className='relative w-[300px] h-[420px] aspect-[3/4] mobile:w-full mobile:max-w-[300px] mobile:h-[420px] overflow-hidden rounded-md shadow-sm pointer-events-none mx-auto'>
        {image && image !== '' ? (
          <Image
            src={image}
            alt={imageAlt || name}
