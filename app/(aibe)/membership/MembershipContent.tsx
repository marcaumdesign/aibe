      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        {user && user.stripeCustomerId && (
          <div className="text-center bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
            <p className="text-text-sub-600 text-paragraph-md mb-4 font-medium">
...
function ManageSubscriptionButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-primary-base text-text-white-0 font-medium hover:bg-primary-base/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
    >
